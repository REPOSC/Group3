...
urlpatterns = [
    ...
    path('get_all_ranks', front_student.get_all_ranks),
    path('get_student_info', back_student.get_student_info),
    ...
    path('get_book_info', front_book.get_book_info),
    ...
    path('del_book', back_book.del_book),
